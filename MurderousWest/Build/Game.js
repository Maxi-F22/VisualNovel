...
(function (Game) {
    ...
    function start(_event) {
        ...
        let scenes = [
            { id: "opening_scene", scene: Game.Opening, name: "Opening Scene", next: "dream_scene" },
            { id: "dream_scene", scene: Game.Dream, name: "Dream Scene", next: "chapter_one_breakfast" },
            { id: "chapter_one_breakfast", scene: Game.Chapter1BreakfastPath, name: "Chapter1 Breakfast Scene", next: "chapter_two_main" },
            { id: "chapter_one_horses", scene: Game.Chapter1HorsesPath, name: "Chapter1 Horses Scene", next: "chapter_two_main" },
            { id: "chapter_two_main", scene: Game.Chapter2Main, name: "Chapter 2 Main Scene" },
            { id: "chapter_two_accusation", scene: Game.Chapter2AccusationPath, name: "Chapter 2 Accusation Scene" },
            { id: "chapter_three_graveyard", scene: Game.Chapter3Graveyard, name: "Chapter 3 Graveyard Scene" },
            { id: "chapter_three_well_beginning", scene: Game.Chapter3WellBeginning, name: "Chapter 3 Well Beginning Scene" },
            { id: "chapter_three_well_interrogation", scene: Game.Chapter3WellInterrogation, name: "Chapter 3 Well Interrogation Scene" },
            { id: "bad_ending", scene: Game.BadEndingDead, name: "Bad Ending Scene", next: "empty" },
            { id: "good_ending", scene: Game.GoodEnding, name: "Good Ending Scene", next: "empty" },
            { id: "medium_ending_killer", scene: Game.MediumEndingKiller, name: "Medium Ending Killer Scene", next: "empty" },
            { id: "medium_ending_free", scene: Game.MediumEndingStillFree, name: "Medium Ending Still Free Scene", next: "empty" },
            { id: "medium_ending_unsolved", scene: Game.MediumEndingUnsolved, name: "Medium Ending Unsolved Scene", next: "empty" },
...
(function (Game) {
    async function Chapter3WellInterrogation() {
        ...
        do {
            let pages = [
                "<strong><u>Beschuldigunsmenü</u></strong><br\><strong>Verbleibende Hinweispunkte: " + Game.dataForSave.cluePoints + "</strong><br\><br\><br\><br\><br\><br\><br\>",
                "Langzeitverschlüsselung,<br\><br\>Seite 2",
                "Seite 3"
            ];
            Game.ƒS.Text.print(pages[current]);
            if (Game.dataForSave.cluePoints === 0 || Game.dataForSave.canLookatPages === (pages.length - 1)) {
